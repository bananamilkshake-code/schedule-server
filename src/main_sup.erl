...
%% @doc This is the main supervisor of Shedule Server server. It looks 
...
%%%
%%% @doc Initializes Shedule Server major modules with the supervision timings provided
%%%
...
init({MaxR, MaxT}) ->
  report(1, "Shedule Server main supervisor initializing"),
  {ok,
    {
